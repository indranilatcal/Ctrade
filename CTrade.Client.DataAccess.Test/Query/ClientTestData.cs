    ...
    public static class ClientTestData
    {
        public static class Artists
        {
            ...
            public static Artist[] CreateArtists(int numOf)
            {
                ...
                return artists.OrderBy(a => a.Id).ToArray();
            }
        ...
        {
            public const string ArtistDesignDoc = "artists";
                ...
                "{" +
                    ...
                    "\"lists\": {" +
                            "\"transformhtml\": \"function(head, req){" +
                                    ...
                                    "});" +
                                "}\"," +
                            "\"transformtojsonwithadditonalqueryparams\": \"function(head, req){" +
                                    "provides('json',function(){" +
                                        "docs = [];" +
                                        "while (row = getRow()) {" +
                                            "docs.push({ name: row.value.name, foo: req.query.foo });" +
                                        "}" +
                    ...
                    "}" +
                "}";
            public const string ArtistsAlbumsView = "albums";
            public const string ArtistsNameNoValueView = "name_no_value";
            public const string ArtistsTotalNumOfAlbumsView = "total_num_of_albums";
            public const string ArtistsNameAsKeyAndDocAsValue = "name_as_key_and_doc_as_value";
            public const string TransformToHtmlList = "transformhtml";
            public const string TransformToDocList = "transformdoc";
            public const string TransformToJsonWithAdditonalQueryParamsList = "transformtojsonwithadditonalqueryparams";
        }
